...
<script type="text/javascript"
	src="${ctx}/js/production_process/pod_button/pod_button_edit.js">
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/produce/pod_button_editEntity.shtml">
		<input type="hidden" class="form-control checkacc"
			name="podButtonFormMap.id" id="id" value="${pod_button.id}">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkabh"
						value="${pod_button.pod_button_no}" placeholder="请输入pod按钮编号"
						name="podButtonFormMap.pod_button_no" id="pod_button_no">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkName"
						value="${pod_button.pod_button_name}" placeholder="请输入pod按钮名称"
						name="podButtonFormMap.pod_button_name" id="pod_button_name">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
			...
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<label class="col-sm-3 control-label">PDD按钮样式</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入POD按钮样式"
						value="${pod_button.pod_icon}" name="podButtonFormMap.pod_icon"
						id="pod_icon" readonly>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入创建人"
						...
						value="${pod_button.by_user }" readonly>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入创建时间"
						...
						value="<fmt:formatDate value="${pod_button.create_time}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly>
				</div>
			</div>
		</div>
