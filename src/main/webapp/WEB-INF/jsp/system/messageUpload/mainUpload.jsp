...
<body>
					...
					<div class="col-sm-12">
						<div class="input-group">
							<input type="file" name="file" style="display: none"> <input
								id="filein" class="input-large" type="text"
	...
	<script type="text/javascript">
		function downDoadFile() {
			...
			form.attr("action", rootPath+"/message/masterDataDownLoad.shtml");
			var input1 = $("<input>");
		...
		$("#fileForm").validate({
			...
			submitHandler : function(form) {//验证成功，就提交表单
				$("#fileForm").ajaxSubmit({
					type : 'post',
					url : rootPath+'/message/masterDataUpload.shtml', //变量
