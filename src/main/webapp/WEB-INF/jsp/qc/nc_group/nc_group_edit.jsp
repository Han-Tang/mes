...
<script type="text/javascript" src="${ctx}/js/qc/nc_group/nc_group_edit.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/nc_group/nc_group_editEntity.shtml">
		<input type="hidden" class="form-control checkacc" value="${ncCodeGroup.id}"
			name="ncCodeGroupFormMap.id" id="id">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkabh"
							...
							value="${ncCodeGroup.nc_code_group_no }" readonly="readonly">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkName"
							...
							value="${ncCodeGroup.nc_code_group_desc }">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select class="form-control" name="ncCodeGroupFormMap.state">
							<option value="1" <c:if test="${ncCodeGroup.state eq 1}"> SELECTED</c:if>>是</option>
							<option value="0" <c:if test="${ncCodeGroup.state eq 0}"> SELECTED</c:if>>否</option>
						</select>
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
